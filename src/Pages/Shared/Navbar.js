            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabindex="0" className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className='hover:bg-accent hover:text-white rounded-lg font-semibold'><Link>Home</Link></li>
                        <li className='hover:bg-accent hover:text-white rounded-lg font-semibold'><Link>About</Link></li>
